 ...
 */
 ...
 class GameOverScene(private val rootService: RootService) : BoardGameScene(1920, 1080), Refreshable {
    ...
    private var playerList = listOf(
        Player("Player1"), Player("Player2"), Player("Player3"), Player("Player4"), Player("Player5"), Player("Player6")
    )
    ...
    //aligns player names
    private var playerLabels = mutableListOf<Label>()
    private var playerImgs = mutableListOf<Label>()
    ...
    private var p1Name = Label(
        width = 300, height = 35, posX = 175, posY = 675, font = playerLabelFont, text = "Loid"
    )
    private var p2Name = Label(
        width = 300, height = 35, posX = 425, posY = 675, font = playerLabelFont, text = "Anya"
    )
    private var p3Name = Label(
        width = 300, height = 35, posX = 675, posY = 675, font = playerLabelFont, text = "Yor"
    )
    private var p4Name = Label(
        width = 300, height = 35, posX = 925, posY = 675, font = playerLabelFont, text = "Franky"
    )
    private var p5Name = Label(
        width = 300, height = 35, posX = 1175, posY = 675, font = playerLabelFont, text = "Sylvia"
    )
    private var p6Name = Label(
        width = 300, height = 35, posX = 1425, posY = 675, font = playerLabelFont, text = "Henry"
    )

    //aligns player image
    private val playerImg1 = Label(
        width = 469, height = 469, posX = 425, posY = 275, visual = ImageVisual("Player1.png")
    )
    private val playerImg2 = Label(
        width = 469, height = 469, posX = 675, posY = 275, visual = ImageVisual("Player2.png")
    )
    private val playerImg3 = Label(
        width = 469, height = 469, posX = 925, posY = 275, visual = ImageVisual("Player3.png")
    )
    private val playerImg4 = Label(
        width = 469, height = 469, posX = 1175, posY = 275, visual = ImageVisual("Player4.png")
    )

    //aligns players Rank
    private var first = Label(
        width = 75, height = 35, posX = 675, posY = 225, visual = ImageVisual("1st.png")
    )
    private val second = Label(
        width = 75, height = 35, posX = 925, posY = 225, visual = ImageVisual("2nd.png")
    )
    private val third = Label(
        width = 75, height = 35, posX = 1175, posY = 225, visual = ImageVisual("3rd.png")
    )
    private val fourth = Label(
        width = 75, height = 35, posX = 1175, posY = 225, visual = ImageVisual("3rd.png")
    )
    private val fifth = Label(
        width = 75, height = 35, posX = 1425, posY = 225, visual = ImageVisual("3rd.png")
    )
    private val sixth = Label(
        width = 75, height = 35, posX = 1675, posY = 225, visual = ImageVisual("3rd.png")
    )

    private val crown = Button(
        width = 100, height = 50, posX = 675, posY = 268, visual = ImageVisual("Crown.png")
    )
