...
/**
 * The Turn class represents a turn in the game, including information about the game field, players, previous turn, next turn and the index of the current player.
 *
